...
- (NSNumber*) amountFromString: (NSString*) string
{
   ...
   //NSParameterAssert( _currencyNumberFormatter.maximumFractionDigits == _currencyNumberFormatter.minimumFractionDigits );
    ...
    NSNumber* n = @([digitString doubleValue] / pow(10.0, fd));
...
{
    if ([NSString isStringEmpty:[[text componentsSeparatedByCharactersInSet: _invalidInputCharacterSet] componentsJoinedByString: @""]]) {
        [super setText: @""];
        return;
    }
