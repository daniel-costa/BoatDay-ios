...
- (instancetype)initWithSectionTitles:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        _type = HMSegmentedControlTypeText;
    }
...
- (instancetype)initWithSectionImages:(NSArray*)sectionImages sectionSelectedImages:(NSArray*)sectionSelectedImages {
    ...
    if (self) {
        ...
        _type = HMSegmentedControlTypeImages;
    }
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            CGFloat y = roundf((CGRectGetHeight(self.frame) - stringHeight) / 2.0);
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.type == HMSegmentedControlTypeText) {
        CGFloat stringWidth = [self.sectionTitles[self.selectedSegmentIndex] sizeWithFont:self.font].width;
    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleCustom) {
        
        CGFloat x = (self.segmentWidth - self.selectionIndicatorWidth) / 2.0;
        
        return CGRectMake(self.segmentWidth * self.selectedSegmentIndex + x, indicatorYOffset, self.selectionIndicatorWidth, self.selectionIndicatorHeight);
