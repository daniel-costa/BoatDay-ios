...
typedef NS_ENUM(NSInteger, HMSegmentedControlSelectionStyle) {
    ...
    HMSegmentedControlSelectionStyleCustom
...
/*
 Width of the selection indicator. Only effective when `HMSegmentedControlSelectionStyle` is `HMSegmentedControlSelectionStyleCustom` 
...
- (instancetype)initWithSectionImages:(NSArray *)sectionImages sectionSelectedImages:(NSArray *)sectionSelectedImages NS_DESIGNATED_INITIALIZER;
